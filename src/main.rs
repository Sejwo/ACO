...
fn main() {
    ...
    model.set_number_of_iterations(2000);
    model.set_ant_count(3500);
    ...
    model.set_rank_limit((3500.0*0.1) as u32); // since i added rank limits(how many best ants will get to leave their pheromones i am including this and creating a branch)
    model.run_model();
}
